            ...
            <aside class="sidebar">
                <div class="scroll-wrapper scrollbar-inner" style="position: relative;"><div class="scrollbar-inner scroll-content scroll-scrolly_visible" style="height: auto; margin-bottom: 0px; margin-right: 0px; max-height: 120px;">

                    <div class="user">
                        <div class="user__info" data-toggle="dropdown">
                            <img class="user__img" src="/admin/images/profile-pic.jpg" alt="">
                            <div>
                    ...
                    <ul class="navigation">
                        ...
                        <li class=""><a href="https://kavity.co/admin/dashboard.php"><i class="zmdi zmdi-home"></i> Home</a></li>
						 <li class=""><a href="https://kavity.co/admin/users.php"><i class="zmdi zmdi-accounts"></i> Users</a></li>
							...
							<li class=""><a href="https://kavity.co/admin/book.php" ><i class="zmdi zmdi-accounts"></i> Test Drive Bookings </a></li>
