...
{
	header('Location: http://theonlineolympiad.com/admin');
}
?>
<html lang="en"><head>
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
        <title>Dashboard - Online Olympiad</title>
        ...
        <main class="main" style="min-height: 85vh;">
            ...
            <header class="header">
                ...
                <div class="logo hidden-sm-down">
                    <h1 class="navigation__active"><a href="#"><img src="http://theonlineolympiad.com/homeassets/img/logo.png" style="width: 100px;"></a></h1>
                </div>
